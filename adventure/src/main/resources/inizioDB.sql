...
(13, 'interagisci'), (13, 'comunica'), (13, 'conversa'), (13, 'chiacchera'),
(16,'butta'),
(17, 'utilizza'),
(18, 'ascen');
...
-- secondo piano
    (8, 'Secondo piano','Prendendo le scale sei al second piano. noti verso NORD una grande stanza.' , 'Non c''è nulla di nuovo',true, true, 'corridoio_secondo_piano.png'),
    ...
    (16, 'Aula A', ' Sei nella tua vecchia aula , dove hai seguito le tanto amata lezioni di fisica. Ci sono due lavagne , una con il pennarello e una con il gesso , sulla quale ci sono scritti dei geroglifici. Sembrerebbe una formula del moto del proiettile o qualcosa del genere. Chissà se possono essere criptati....', 'Osservando meglio la stanze noti un bigliettino sotto il banco dell''ultima fila è il bigliettino che permette di criptare la formula del moto del...qualcosa.(fisica non era la tua materia preferita...)',true, true, 'aula_A_secondo_piano.png'),-- Prende il bigliettino per poi poter aiutare lo stendete. Se no deve sperare nelle sue conoscenze
-- terzo piano
    (14, 'Terzo piano', 'Sei finalmente arrivato al terzo piano.\n Nel corridoio non c''è nessuno. Del bagno nemmeno l''ombra. Noti a destra (EST) l''aula studio e sulla tua sinistra (OVEST) intravedi il museo di informatica',' Senti dei schiamazzi provenire dall''aula studio , forse c''è qualcuno.', true, true, 'corridoio_terzo_piano.png'),
    (15, 'Aula studio terzo piano', 'La stanza è piena di tavoli scricchiolanti, ma almeno qui le sedie non sono rotte.... Noti uno studente ansioso e spaventato che sta studiando qualcosa, potresti aiutarlo , chissà se per sdebitarsi ti darebbe delle informazioni utili....', 'C''è uno studente ansioso e spaventato sulla tua destra potresti aiutarlo', true, true, 'aula_studio_terzo_piano.png'),-- se viene aiutato da un indizio su una scheda magica che può aprire qualsiasi porta e che ti fa vedere cose fuori dal comune(per il bagno magico) serviranno componenti obsolete per costruirla
...
--2--HO--LA--CANDEGGINA--
('Ecco la candeggina. L''ho trovata nel laboratorio di robotica.',32,33,10),
