...
(8, 'MONETA DI METALLO', 'Una moneta particolare, lontana dalle consuete monete europee, dal peso piacevolmente consistente. Da un lato è inciso un piccolo water, mentre dall''altro spicca un simbolo enigmatico che somiglia a una libreria.',false,false,false,true,-1,'moneta.png', true),
...
(12, 'TESSERA SMAGNETIZZATA','Una tessera bianca, dall''aspetto anonimo, priva del chip che le darebbe vita. Un tempo poteva essere una carta di accesso o una vecchia tessera servizi, ora ridotta a un semplice pezzo di plastica apparentemente inutile.', false,false,false,false,-1, 'tessera_smagnetizzata.png', true ),
