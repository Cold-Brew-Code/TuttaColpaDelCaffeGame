...
import it.tutta.colpa.del.caffe.adventure.utility.Utils;
import it.tutta.colpa.del.caffe.adventure.utility.Parser;
...
public class Engine {
    ...
    public Engine(GameDescription game) {
        ...
        try {
            Set<String> stopwords = Utils.loadFileListInSet(new File("./adventure/src/main/resources/stopwords"));
