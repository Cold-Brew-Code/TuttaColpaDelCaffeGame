...
insert into Oggetto(id,nome, descrizione, contenitore,apribile, leggibile, cliccabile, visibile, componibile, utilizzi, immagine)
values 
...
a che fare con il lanciare cose molto lontano (e con sorprendente precisione).',false,false,true,false,true,false,-1,"bigliettino.png"),
...
, true,false,false,false, true,true,-1,"scheda_madre.png"),
-- QUARTO PIANO
...
true,true,false,false,true,false,-1,"borsellino.png"),
...
mentre dall''altro spicca un simbolo enigmatico che somiglia a una libreria.',true,false,false,false,false,true,-1,"moneta.png"),
(10, 'PENNA NULL','Una comunissima penna a sfera, con il tappo morsicato e l''inchiostro forse già secco.', false, false,false,false,false,false,-1,"penna.png"),
--QUINTO PIANO
...
custodisse qualcosa di immobile. Sul retro è inciso in piccolo un simbolo misterioso: 7L.', true,true, false, false,true,false,-1,"scatola.png"),
...
(12, 'TESSERA SMAGNETIZZATA','Una tessera bianca, dall''aspetto anonimo, priva del chip che le darebbe vita. Un tempo poteva essere una carta di accesso o una vecchia tessera servizi,
 ora ridotta a un semplice pezzo di plastica apparentemente inutile.', false,false,false,false,false,true,-1, "tessera_smagnetizzata.png" ),

(13, 'CARTA IGIENICA', 'Un semplice rotolo di carta igienica, leggermente sgualcito ai bordi.', false,false,false,false,false,false,-1, "carta_igienica.png"),
...
Ma la sua magia è fragile come un fiammifero al vento: può brillare solo poche volte prima che il mistero che la anima si consumi del tutto....',false,false,false,false,false,false,2,"tessera_magica.png"),
...
insert into stanza(id, nome, descrizioneIniziale, descrizioneAggiuntiva, aperta, visibile, immagine)
values
...
--piano terra
(5, 'Aula studio piano terra', 'Un''aula rettangolare con tavoli lunghi e sedie rovinate. Libri dimenticati, fogli sparsi e zaini abbandonati. Ci sono diversi cartelloni sulla parete.', 'Ci sono tanti cartelloni attaccati al muro e ci sono anche scritte strane su alcuni tavoli: "Punta in alto per la felicità" , "7FN"" ecc',true,true,"pianoT.png"),-- la mappa la facciamo trovare  solo se passa l'indovinello
-- primo piano 
...
'Se osservi con attenzione tra i tanti quadri, uno di questi raffigura una libreria con sopra un rotolo di carta igienica. La libreria non è un semplice mobile: è in realtà una porta segreta, leggermente socchiusa, dalla quale filtra una luce accecante.',false,true,"sala_consiglio_settimo_piano.png"),--chiusa
...
L’aria profuma di fiori esotici, e persino il getto del rubinetto sembra scorrere più elegante qui dentro. È il trionfo, la meta, la fine del viaggio: il bagno segreto del settimo piano. ' , '',false,false,"bagno_segreto_settimo_piano.png"),
...
INSERT INTO Dialoghi (id, NPC) VALUES
(1,7), (2,1), (3,1), (4,1),
(5,2), (6,3), (7,4), (8,4),
(9,4), (10,5),(11,5), (12,6);

INSERT INTO DomandeDialoghi(dialogo, id, domanda) VALUES

-- domande bar :
--1
(1,1,'Ciao!'), 
--2
(1,2,'Un bagno? Uhm… fammi pensare… Allora, 
nell''antica Roma i bagni pubblici si chiamavano thermae… e poi c''erano anche le latrinae...'),
--3
(1,3,'Ah! Allora… credo… no aspetta, forse era dietro il dipartimento di Filosofia… o 
forse davanti alla segreteria…'),
--4
(1,4,'Ehm... no, scusa... sono solo al primo anno di Storia e credo di aver sbagliato strada… il dipartimento mio 
...
--1---
(4,11,'Guarda chi torna... Hai la faccia di chi ha capito che le scale non sono sempre l''opzione migliore, eh?
...
--2--
(4,12,'Bravo! L''ereditarietà multipla è bandita in Java: troppi casini col diamante, dicono.
Va bene, prendi questa chiave: ti apre l''ascensore fino al settimo piano.Ma occhio: più sali, più i misteri si complicano.'),
--3--
(4,13,'Mi dispiace, ragazzo. Se Java vietasse pure l''ereditarietà semplice, non resterebbe molto da estendere, eh?
Riprova quando ti ricordi come funziona davvero l''O.O.'),
...
--1--
(6,17,'Oh… tu sembri meno disperato di me… Forse puoi aiutarmi!Ho questo maledetto dubbio sul moto parabolico. Se mi aiuti, 
potrei ricompensarti… con informazioni che pochi conoscono.'),
--2--
...
i quali servono per costruire una scheda magica che può aprire qualsiasi porta e mostrare cose che sfuggono agli altri.'),
--4--
...
--1--
(8,25,'Oh, bentornato! spero che questa volta ti vada meglio, rispondi a quesata domanda facile facile ,  roba del primo semestre e potrai saltare la fila. 
Se rappresenti un grafo con una matrice di adiacenza, qual è la complessità dell''aggiunta o rimozione di un nodo?'),
--2--
...
--3--
(8,27,'Eh no… per una lista di adiacenza sarebbe O(n), ma con una matrice è più pesante:
O(n^2). Mi dispiace, resta in coda come tutti gli altri!'),
...
--2--
(9,29,'Bravo! Esatto: non puoi creare oggetti direttamente da una classe astratta.
Dai, passa… corri! Che la forza sia con te (e col tuo intestino).'),
--3--
...
--2--
(11,36,'Calma, ragazzo. Ricorda: nessuna corsa può essere vinta 
...
--2--
(12,39,'Ah… scusami! Non ce l''ho con te… è che ho un dolor di pancia pazzesco…
Sarà stato quel maledetto caffè del bar… Fra poco devo pure laurearmi… Non è che, per caso, sai dove sia un bagno qui vicino?'),
--3--
(12,40,'Capisco… va bene… speriamo di trovarlo in tempo.
...
INSERT INTO RisposteDomande(risposta, domanda_partenza, domanda_arrivo,dialogo) VALUES
-- risposte bar---------------
