...
insert into Oggetto(id,nome, descrizione, apribile, leggibile, cliccabile, visibile, componibile)
values 
...
l''ascensore del dipartimento, portando chi la possiede verso piani superiori a una velocità elevata', false,false,false,false,false),

(1, 'LA MAPPA DEL FUORICORSO'. ' Questa mappa costruita da studenti che vaga da anni nel dipartimento, rileva segreti e stanze nascoste all''interno del dipartiemnto.')
...
possa restare vigile abbastanza da affrontare persino le lezioni del mattino e le infinite code in segreteria.', false, false,false, false, false, -1),
--PRIMO PIANO
...
chi osa cercarla finisca per perdersi in un labirinto di problemi apparentemente “facili”',false,true,false,true,false, -1),
-- SECONDO PIANO
...
un po'' come gli esami facili al primo appello.', false,false, false,fasle, false,-1), 
(15, 'ARMADIETTO','Classico armadietto di metallo',true,false,false,true,false,-1),
...
a che fare con il lanciare cose molto lontano (e con sorprendente precisione).',false,true,false,true,false,-1),
...
mentre dall''altro spicca un simbolo enigmatico che somiglia a una libreria.',false,false,false,false,true,-1)
(10, 'PENNA NULL','Una comunissima penna a sfera, con il tappo morsicato e l''inchiostro forse già secco.', false,false,false,false,false,-1),
--QUINTO PIANO
...
custodisse qualcosa di immobile. Sul retro è inciso in piccolo un simbolo misterioso: 7L.', true, false, false,true,false,-1)
...
(12, 'TESSERA SMAGNETIZZATA','Una tessera bianca, dall''aspetto anonimo, priva del chip che le darebbe vita. Un tempo poteva essere una carta di accesso o una vecchia tessera servizi,
 ora ridotta a un semplice pezzo di plastica apparentemente inutile.', false,false,false,false,true,-1 )

(13, 'CARTA IGIENICA', 'Un semplice rotolo di carta igienica, leggermente sgualcito ai bordi.', false,false,false,false,false,-1),
...
Ma la sua magia è fragile come un fiammifero al vento: può brillare solo poche volte prima che il mistero che la anima si consumi del tutto....',false,fasle,false,false,false,2),
...
come bisbigli incoraggianti per studenti assonnati e docenti esausti. Un piccolo altare tecnologico dedicato al culto quotidiano della caffeina.', false,false, true, true,true,-1 );
...
(4, 'Dipartimento di Informtica', 'Un atrio ampio ma freddo, pavimento in marmo consumato e neon tremolanti. Dietro un vetro spesso, il portinaio osserva chi entra e chi esce, sfogliando distrattamente un giornale. Alla sua sinistra, un vecchio ascensore con porte rumorose e delle scala che portano verso i piani superiori.', ' Ti ritrovi di nuovo al piano terra. Il portinaio, mezzo addormentato, armeggia con un mazzo di chiavi che sembra non finire mai, mentre si trascina verso l''ultima pagina del giornale', '');

--piano terra
(5, 'Aula studio piano terra', 'Un''aula rettangolare con tavoli lunghi e sedie rovinate. Libri dimenticati, fogli sparsi e zaini abbandonati. Ci sono diversi cartelloni sulla parete.', 'Ci sono tanti cartelloni attaccati al muro e ci sono anche scritte strane su alcuni tavoli: "Punta in alto per la felicità" , "7FN"" ecc');-- la mappa la facciamo trovare  solo se passa l'indovinello
-- primo piano 
(6, 'Primo piano', 'Scale conducono qui. \nAppena arrivi, il corridoio si apre su un bagno, che però scopri subito essere occupato dallo Studente Modello, intento a porre enigmi filosofico-informatici. ', 'A nord e ovest ci sono altre due porte, chissa cosa nascondono.')
(7, 'Biblioteca','Una stanza lunga, con scaffali traboccanti di manuali di informatica, riviste accademiche e vecchie tesi impolverate. La luce filtra da grandi finestre, e il silenzio è interrotto solo dal fruscio di pagine e dal ticchettio di una tastiera. Un ottimo posto per scoprire curiosità… o nascondere indizi.', 'Al secondo sguardo noti un libro che sta per cadere , il quale si intitola Calcolabilità e Complessita. Chissa che segreti  nasconde....\n');-- se prende il libro può usarlo per risolvere l'indovinello di p=np
(12, 'Bagno primo piano', 'Finalemnte il bagno!. Ma purtroppo pare sia occupato da uno studente', ' alla tua sinistra c''è una luce accecante , IL BAGNO  sulla porta è appeso un foglietto con scritto: “Risolvi, e potrai muoverti con maestria all''interno del dipartimento.”' )

-- secondo piano 
(8, 'Secondo piano','Prendendo le scale sei al secodo piano. noti verso NORD una garnde stanza.' , 'Non c''è nulla di nuovo');
(9, 'Robotica', 'Un laboratorio pieno di bracci meccanici spenti, monitor sfarfallanti e componenti elettronici sparsi.' , 'Un braccio meccanico inattivo si muove di scatto quando passi vicino, il quale punta sempre verso un armadietto a destra.'); -- trova la varechina richiesta dall'inserviente 
(16, 'Aula A', ' Sei nella tua vecchia aula , dove hai seguito le tanto amata lezioni di fisica. Ci sono due lavagne , una con il pennarello e una con il gesso , sulla quale ci sono scritti dei geroglifici. Semprerebbe una formula del moto del proiettila o qualcosa del genere. Chissà se possono essere criptati....', 'Osservando meglio la stanze noti un bigliettino sotto il banco dell''utlima fila è il biglittino che permette di criptare la formula del moto del...qualcosa.(fisica non era la tua materia preferita...) ')-- prende il bigliettino per poi poter aiutare lo stundete . se no deve sperare nelle sue conoscenze 

-- terzo piano 
(14, 'Terzo piano', 'Sei finalemente arrivato al terzo piano.\n Nel corridoio  non c''è nessuno. Del bagno nemmeno l''ombra. Noti a destra (EST) l''aula studio e sulla tua sinistra (OVEST) intravedi il museo di informatica',' Senti dei schiamazzi provenire dall''aula stuido , forse c''è qualcuno.' );
(15, ' Aula studio terzo piano', 'La stanza è piena di tavoli scricchiolanti, ma almeno qui le sedie non sono rotte.... Noti uno studente ansioso e spaventato che sta studiando qualcosa, potresti aiutarlo , chissà se per sdebitarsi ti darebbe delle informazioni utili....', 'C''è uno studente ansioso e spaventato sulla tua destra potresti aiutarlo')-- se viene aiutato da un indizio su una scheda magica che può aprire qualsiasi porta e che ti fa vedere cose fuori dal comune(per il bagno magico) serviranno componenti obselete per costruirala 
(30, 'Museo di informatica', ' Sei in una stanza piena di vecchi computer, di fronte a te, un monitor a tubo catodico grande quanto un forno a microonde, schede madri imbalsamate e sulle pareti  manuali ingialliti che giurano di spiegare come installare Windows 95, ma solo se sai leggere il sanscrito.',  ' Osservando la stanza noti una scheda madre rovinata e l''uscita verso EST!' )-- se fa raccogli prende la scheda madre rovinata che sarà utile per costruire la scheda magica 


-- quarto piano
(10, 'Quarto piano','Corridorio stretto e affollato, con una fila interminabile che si snoda fuori dal bagno. L''aria è un misto di ansia ed esausta rassegnazione. Tra la fila, studenti leggono libri di algoritmi o ripassano appunti. Potresti parlare con qualcuno... magari capiscono la tua urgenza e ti lasciano passare.', 'La solita fila Kilometrica di studenti ansiosi, e un inserviente arrabbiato per via del bagno sporco. È alla ricerca di CANDEGGINA ');
(11, ' Bagno quarto piano', 'Un''altro bagno! Può essere la volta buona. All''interno, l''odore forte di disinfettante si mescola a quello più pungente dell''ansia collettiva\n. Specchi graffiati riflettono volti stanchi, e le porte cigolano ad ogni movimento.', 'Maledizione , manca la carta igienica.\nTra i muri, qualcuno ha disegnato un piccolo graffito, un palazzo con un punto interrogativo all''ultimo piano Chissà......')
(13, 'Laboratorio Boole', 'Nascosto dalla lunga fila di studenti di fronte a te (NORD) si intravede un laboratorio di informatica , dove all''interno ci sono studenti fuori corso cercano di crare la macchina di turing universale che risolva il problema della fermata.', 'I soliti tre studenti che vogliono rislvere il problema della fermata... Opsss stavi inciampato su qualcosa. Un borsellino chissa che sta dentro.')-- se lo raccoglie al suo interno ci sono 5 monete e varie penne (il suo contenuto è noto solo se lo apre)

-- quinto piano 
(17, 'Quinto piano', 'Un corridoio silenzioso con porte chiuse e targhette in ottone.', 'Sei di nuovo al quinto piano, non noti niente di nuovo , a sinistra(OVEST) e a destra (EST) ci sono gli uffici dei professori. Potrebbero nascondere qualcosa di utile. Chissà se questi oggetti sono davvero indipendenti.... o se dietro le quinte hanno implementato un composite pattern!')
...
values
(5,1,1), (7,3,1), (9,15,1),(9,4,1), (16,5,1),(30,6,1), (13,7,1), (13,8,4), (13,10,6), (19,11,1),(19,12,1), (25,16,1);
